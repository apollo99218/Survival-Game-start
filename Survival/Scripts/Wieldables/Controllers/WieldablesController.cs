...
namespace SurvivalTemplatePro.WieldableSystem
{
    ...
    public class WieldablesController : CharacterBehaviour, IWieldablesController
    {
        ...
        public bool TryEquipWieldable(IWieldable wieldable, Item itemToAttach = null, float holsterSpeed = 1f, bool forceEquip = false)
        {
            if (!forceEquip && CanNotEquip(itemToAttach))
                return false;
