...
namespace SurvivalTemplatePro.CameraSystem
{
    ...
    public class CameraMotionHandler : CharacterBehaviour, ICameraMotionHandler
    {
        ...
        private Spring.Settings m_ShakeSpringSettings = Spring.Settings.Default;
        ...
        private Spring.Settings m_DefaultForceSpringSettings = Spring.Settings.Default;

        // Springs
        private Spring m_RotationMotionSpring;
        private Spring m_PositionMotionSpring;
        ...
        public override void OnInitialized()
        {
            ...
            m_PositionMotionSpring = new Spring(Spring.RefreshType.OverridePosition, m_Camera, default, m_MotionLerpSpeed);
            m_RotationMotionSpring = new Spring(Spring.RefreshType.OverrideRotation, m_Camera, default, m_MotionLerpSpeed);

            m_PositionShakeSpring = new Spring(Spring.RefreshType.AddToPosition, m_Camera, default, m_ShakeLerpSpeed, m_ShakeSpringSettings);
            m_RotationShakeSpring = new Spring(Spring.RefreshType.AddToRotation, m_Camera, default, m_ShakeLerpSpeed, m_ShakeSpringSettings);

            m_CustomForceSpring = new Spring(Spring.RefreshType.AddToRotation, m_Camera, default, m_ForceLerpSpeed, m_DefaultForceSpringSettings);
